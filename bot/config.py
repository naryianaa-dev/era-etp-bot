...
class Settings(BaseSettings):
    ...
    # По умолчанию подставлены боевые реквизиты физлица-плательщика НПД
    # (самозанятого); при необходимости переопределяются через переменные
    # окружения (Railway / .env).
